let myFont;
let history = [];
let binSize = Tone.getContext().sampleRate / 2 / 64; //calculate the binsize according to the sampleRate of ppl's computers

function preload() {
  myFont = loadFont("fonts/subway.ttf"); // https://p5js.org/reference/p5/loadFont/
